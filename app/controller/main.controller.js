angular.module("AgentHelp").controller("MainCtrl", ["$scope", "$rootScope", "$route", "$location", "AuthService", "AdminService", "AgentService", "$timeout", function ($scope, $rootScope, $route, $location, AuthService, AdminService, AgentService,$timeout) {
    ...
    $scope.pageView = {
        // current:window.localStorage.getItem("loggedInUserType"),
                ...
                if ($scope.pageView.masterLoaded) {
                    ...
                    if (this.current === AGENT) {
                        ...
                        AdminService.masters.retrieveMasters((error, data) => {
                            ...
                            //     return
                            // }
                            // $scope.constants.window.dataStorage.setItem("masters", data)
    ...
    $scope.logout = function () {
        // $scope.constants.window.localStorage.clear();
